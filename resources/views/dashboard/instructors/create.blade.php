        ...
        <div class="row row-tight" style="margin-top: 16px;">
            <div class="col-md-12">
                ...
                <section class="m-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.instructors.store') }}" method="POST" id="instructorCreateForm">
                            @csrf
                            ...
                            <!-- Profile Image Section with Cropper -->
                            <div class="mb-4 text-center">
                                <label class="form-label d-block text-start fw-bold">Profile Image</label>
                                
                                <div class="avatar-preview-container">
                                    <img id="avatarPreview" src="{{ asset('assets/images/default-avatar.png') }}" alt="Instructor Preview">
                                </div>

                                <input type="file" id="imageInput" class="form-control rounded-3" accept="image/*">
                                <div class="form-text text-start mt-1">Select an image to open the cropper tool before submitting.</div>
                            </div>
