...
<main class="main-content" id="main-content">
    <div class="section__content section__content--p30">
        <div class="row row-tight" style="margin-top: 16px;">
            <div class="col-md-12">
                <section class="m-card" aria-labelledby="edit-unit-title">
                    <header class="m-card__header d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="m-card__title" id="edit-unit-title">Edit Unit</h2>
                            <p class="m-card__subtitle">Update details for unit: <strong>{{ $unit->title }}</strong></p>
                        </div>
                    ...
                    <div class="card-body mt-3">
                        <form action="{{ route('admin.units.update', $unit->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $unit->title) }}" placeholder="e.g. Unit 1: Introduction to Freight Forwarding" required>
                                @error('title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="order" id="order" class="form-control @error('order') is-invalid @enderror" value="{{ old('order', $unit->order) }}" min="1">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Optional unit overview or summary...">{{ old('description', $unit->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="au-btn au-btn--green au-btn--small text-decoration-none">
                                    <i class="fa-solid fa-floppy-disk me-1"></i> Update Unit
                                </button>
                            </div>
                        </form>
                    </div>
